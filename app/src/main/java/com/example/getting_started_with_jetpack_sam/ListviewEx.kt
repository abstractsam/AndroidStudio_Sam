...
private val countryList = mutableListOf("Kenya", "Rwanda", "Uganda", "Burundi")
private  val listModifier = Modifier
    .fillMaxSize()
    .background(Color.DarkGray)
    .padding(13.dp)

private  val textStyle = androidx.compose.ui.text.TextStyle(fontSize = 40.sp, color=Color.White)
